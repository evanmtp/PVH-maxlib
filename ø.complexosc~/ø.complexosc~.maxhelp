...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 30.0, 105.0, 176.0, 22.0 ],
					"style" : "",
					"text" : "ø.complexosc~.model osc_test"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "ø.complexosc~.model.maxpat",
				"bootpath" : "~/Desktop/o.complexosc~",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
